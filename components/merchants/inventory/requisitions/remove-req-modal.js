...
import { fetchRequisitionList,deleteRequisition } from "@/store/merchants/inventory/requisition-slice";
import { useDispatch, useSelector } from "react-redux";
import { showNotification } from "@mantine/notifications";

function RemoveReqModal({ item }) {
  ...
  async function submitDetails() {
    ...
    try {
      dispatch(deleteRequisition(params));
      ...
      dispatch(fetchRequisitionList(params));
      setOpened(false);
