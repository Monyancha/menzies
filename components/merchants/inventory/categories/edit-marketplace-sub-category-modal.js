...
function EditMarketplaceSubCategory({ category }) {
  ...
  const isSubmitting = useSelector(
    (state) => state.categories.mcSubEditSubmissionStatus == "loading"
  );
  ...
  async function submitDetails() {
    ...
    try {
      await store.dispatch(submitEditMarketplaceSubCategory(params)).unwrap();
...
export default EditMarketplaceSubCategory;
