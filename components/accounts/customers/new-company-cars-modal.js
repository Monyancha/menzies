      ...
      >
        <Formik
          ...
          onSubmit={async (values) => {
            const url = `/accounts/companies/${companyId}/cars`;
          ...
          {({ setFieldValue, values, errors, touched }) => (
            <Form>
              <section className="flex flex-col space-y-2 p-3 rounded-lg">
                <span className="text-sm font-bold">Car Details</span>
...
export default NewCompanyCarsModal;
