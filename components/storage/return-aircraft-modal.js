...
function ReturnAircraftModal({item}) {
  ...
  const  handleSubmit = async (e) => {
    ...
    if (response.status === 200) {
      showNotification({
        title: "Success",
        message: "Return to Aircraft successful!",
        color: "green",
      });
      clearForm();
      setLoading(false);
  ...
  return (
    <>
      <Modal
        opened={opened}
        title="Return Cargo to Aircraft"
...
export default ReturnAircraftModal;
