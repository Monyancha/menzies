...
import { getStaff } from "../../src/store/cargo/cargo-slice";
...
export default function Users() {
  ...
  const itemStatus = useSelector(
    (state) => state.cargo.getStaffStatus
  );
  const items = useSelector((state) => state.cargo.getStaff);
