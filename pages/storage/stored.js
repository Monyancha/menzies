...
import ReturnAircraftModal from "../../components/storage/return-aircraft-modal";
...
export default function Cargo() {
  ...
  const storage = items?.lists?.storedCargo;
  ...
  return (
    <PageContainer>
      {/* breadcrumb */}
      <Breadcrumb title="Stored Cargo" items={BCrumb} />
      {/* end breadcrumb */}
      <Box>
        ...
        <div className="w-full flex flex-wrap mt-2">
          ...
          <DashboardCard title="Stored Cargo" value={dashboard?.stored_cargo ?? 0} color="brown" />
          <DashboardCard title="Awaiting Storage" value={dashboard?.storage_pallets ?? 0} color="purple" />
          <DashboardCard title="Total Cargo" value={dashboard?.cargo ?? 0} color="blue" />
        </div>
        </div>         
