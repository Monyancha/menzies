...
import StoreCargoModal from "../../components/storage/store-cargo-modal";
...
export default function Cargo() {
  ...
  const storage = items?.lists?.storagePallets;
  ...
  return (
    <PageContainer>
      {/* breadcrumb */}
      <Breadcrumb title="Awaiting Storage" items={BCrumb} />
      {/* end breadcrumb */}
      <Box>
        ...
        <div className="w-full flex flex-wrap mt-2">
          ...
          <DashboardCard title="Stored Cargo" value={dashboard?.stored_cargo ?? 0} color="green" />
