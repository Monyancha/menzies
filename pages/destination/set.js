...
import SetDestinationModal from "../../components/destination/set-destination-modal";
...
const BCrumb = [
  ...
  {
    title: "Destination Set ULDs",
  },
];

export default function Palleted() {
  ...
  const pallets = items?.lists?.palletedUlds;
  ...
  return (
    <PageContainer>
      {/* breadcrumb */}
      <Breadcrumb title="Destination Set ULDs" items={BCrumb} />
      {/* end breadcrumb */}
      <Box>
        ...
        <div className="w-full flex flex-wrap mt-2">
          ...
          <DashboardCard title="Destination Set ULDs" value={dashboard?.palleted_ulds ?? 0} color="purple" />
          <DashboardCard title="Awaiting Destination ULDs" value={dashboard?.pallet_ulds ?? 0} color="brown" />
          <DashboardCard title="Total Cargo" value={dashboard?.cargo ?? 0} color="green" />
        </div>
        </div>         
