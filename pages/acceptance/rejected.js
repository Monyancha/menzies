...
export default function Rejected() {
  ...
  return (
    <PageContainer>
      {/* breadcrumb */}
      <Breadcrumb title="Rejected Cargo" items={BCrumb} />
      {/* end breadcrumb */}
      <Box>
        ...
        <div className="w-full flex flex-wrap mt-2">
          ...
          <DashboardCard title="Awaiting Acceptance" value={dashboard?.awaiting ?? 0} color="purple" />
          <DashboardCard title="Total Cargo" value={dashboard?.cargo ?? 0} color="red" />
          <DashboardCard title="Total Check In" value={dashboard?.visits_in ?? 0} color="orange" />
          <DashboardCard title="Total Visits" value={dashboard?.visits ?? 0} color="green" />
        </div>
        </div>
