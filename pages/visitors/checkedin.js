...
export default function Visitors() {
  ...
  const visitors = items?.lists?.visitsIn;
  ...
  return (
    <PageContainer>
      {/* breadcrumb */}
      <Breadcrumb title="Checked In Visitors" items={BCrumb} />
      {/* end breadcrumb */}
      <Box>
        ...
        <div className="w-full flex flex-wrap mt-2">
          ...
          <DashboardCard title="Total Check Out" value={dashboard?.visits_out ?? 0} color="purple" />
        </div>
        </div>
