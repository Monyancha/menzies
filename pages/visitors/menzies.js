...
import CheckinMenziesModal from "../../components/staff/checkin-menzies-modal";
...
export default function Visitors() {
  ...
  const visitors = items?.lists?.menziesvisitors;
console.log("visitors menzies", visitors);
  //Get Dashboard Stats
  ...
  return (
    <PageContainer>
      {/* breadcrumb */}
      <Breadcrumb title="Menzies Staff" items={BCrumb} />
      {/* end breadcrumb */}
      <Box>
        ...
        <div className="w-full flex flex-wrap mt-2">
          ...
          <DashboardCard title="Total Visits" value={dashboard?.menzies_visits ?? 0} color="purple" />
          <DashboardCard title="Total Check In" value={dashboard?.menzies_visits_in ?? 0} color="green" />
          <DashboardCard title="Total Check Out" value={dashboard?.menzies_visits_out ?? 0} color="red" />
        </div>
        </div>
