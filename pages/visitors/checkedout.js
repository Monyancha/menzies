...
export default function Visitors() {
  ...
  const visitors = items?.lists?.visitsOut;
  ...
  return (
    <PageContainer>
      {/* breadcrumb */}
      <Breadcrumb title="Checked Out Visitors" items={BCrumb} />
      {/* end breadcrumb */}
      <Box>
        ...
        <div className="w-full flex flex-wrap mt-2">
          ...
          <DashboardCard title="Total Check Out" value={dashboard?.visits_out ?? 0} color="indigo" />
          <DashboardCard title="Total Visitors" value={dashboard?.visitors ?? 0} color="red" />
          <DashboardCard title="Total Visits" value={dashboard?.visits ?? 0} color="orange" />
