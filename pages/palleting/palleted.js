...
export default function Palleted() {
  ...
  const pallets = items?.lists?.pallets;
  ...
  return (
    <PageContainer>
      {/* breadcrumb */}
      <Breadcrumb title="Palleted Cargo" items={BCrumb} />
      {/* end breadcrumb */}
      <Box>
        ...
        <div className="w-full flex flex-wrap mt-2">
          ...
          <DashboardCard title="Total Palleted" value={dashboard?.pallets ?? 0} color="blue" />
          <DashboardCard title="Awaiting Palleting" value={dashboard?.logged_out ?? 0} color="purple" />
