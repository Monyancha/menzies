...
import PalletCargoModal from "../../components/palleting/pallet-cargo-modal";
...
export default function Palleting() {
  ...
  const loggedout = items?.lists?.loggedOut;
  ...
  return (
    <PageContainer>
      {/* breadcrumb */}
      <Breadcrumb title="Awaiting Palleting" items={BCrumb} />
      {/* end breadcrumb */}
      <Box>
        ...
        <div className="w-full flex flex-wrap mt-2">
          ...
          <DashboardCard title="Awaiting Palleting" value={dashboard?.awaiting ?? 0} color="blue" />
          <DashboardCard title="Awaiting Palleting" value={dashboard?.logged_out ?? 0} color="green" />
          <DashboardCard title="Total Palleted" value={dashboard?.pallets ?? 0} color="purple" />
