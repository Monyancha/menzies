...
export default function ConsignmentsReport() {
                ...
                {!isLoading &&
                  ...
                  items?.data?.map((item) => (
                    <tr className="border-b" key={item?.id}>
                      ...
                      <td>
                        <Link
                          href={`/consignments/${item?.id}?code=${item?.code}`}
                        >
                          <Button leftIcon={<IconEye size={18} />} size="xs" variant="outline">
                            View Details
                          </Button>
                        </Link>
                      </td>
