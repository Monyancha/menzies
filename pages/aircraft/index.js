...
import OffloadCargoModal from "../../components/aircraft/offload-cargo-modal";
import ReturnCargoModal from "../../components/aircraft/return-cargo-modal";
...
export default function Cargo() {
  ...
  const aircraft = items?.lists?.aircraftPallets;
  ...
  return (
    <PageContainer>
      {/* breadcrumb */}
      <Breadcrumb title="Awaiting Offload" items={BCrumb} />
      {/* end breadcrumb */}
      <Box>
        ...
        <div className="w-full flex flex-wrap mt-2">
          ...
          <DashboardCard title="Awaiting Offload" value={dashboard?.aircraft_pallets ?? 0} color="brown" />
          <DashboardCard title="Offloaded Cargo" value={dashboard?.offloaded_cargo ?? 0} color="blue" />
          <DashboardCard title="Returned Cargo" value={dashboard?.offloaded_cargo ?? 0} color="green" />
        </div>
        </div>          
                  ...
                  aircraft?.map((item) => (
                    <tr key={item?.id} className="border-b" >
                      ...
                      <td className="text-right"> 
                        ...
                        <OffloadCargoModal item={item} />{'  '} 
                        <ReturnCargoModal item={item} />
