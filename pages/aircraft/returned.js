...
export default function Returned() {
  ...
  return (
    <PageContainer>
      {/* breadcrumb */}
      <Breadcrumb title="Returned Cargo" items={BCrumb} />
      {/* end breadcrumb */}
      <Box>
        ...
        <div className="w-full flex flex-wrap mt-2">
          ...
          <DashboardCard title="Returned Cargo" value={dashboard?.offloaded_cargo ?? 0} color="brown" />
          <DashboardCard title="Offloaded Cargo" value={dashboard?.offloaded_cargo ?? 0} color="purple" />
          <DashboardCard title="Awaiting Offload" value={dashboard?.aircraft_pallets ?? 0} color="blue" />
        </div>
        </div>           
