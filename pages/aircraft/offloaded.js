...
export default function Offloaded() {
  ...
  const offloaded = items?.lists?.offloadedCargo;
  ...
  return (
    <PageContainer>
      {/* breadcrumb */}
      <Breadcrumb title="Offloaded Cargo" items={BCrumb} />
      {/* end breadcrumb */}
      <Box>
        ...
        <div className="w-full flex flex-wrap mt-2">
          ...
          <DashboardCard title="Awaiting Offload" value={dashboard?.aircraft_pallets ?? 0} color="green" />
          <DashboardCard title="Returned Cargo" value={dashboard?.offloaded_cargo ?? 0} color="purple" />
        </div>
        </div>          
