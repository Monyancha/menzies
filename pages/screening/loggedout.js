...
export default function LoggedOut() {
  ...
  return (
    <PageContainer>
      {/* breadcrumb */}
      <Breadcrumb title="Logged Out Cargo" items={BCrumb} />
      {/* end breadcrumb */}
      <Box>
        ...
        <div className="w-full flex flex-wrap mt-2">
          ...
          <DashboardCard title="Awaiting Screening" value={dashboard?.awaiting ?? 0} color="purple" />
          <DashboardCard title="Total Logged Out" value={dashboard?.logged_out ?? 0} color="green" />
          <DashboardCard title="Total Screened" value={dashboard?.screened ?? 0} color="blue" />
