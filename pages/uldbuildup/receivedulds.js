...
export default function ReceivedUlds() {
  ...
  const received = items?.lists?.receivedUlds;
  ...
  return (
    <PageContainer>
      {/* breadcrumb */}
      <Breadcrumb title="Received ULDs" items={BCrumb} />
      {/* end breadcrumb */}
      <Box>
        ...
        <div className="w-full flex flex-wrap mt-2">
          ...
          <DashboardCard title="Total ULDs" value={dashboard?.total_ulds ?? 0} color="purple" />
        </div>
        </div>          
